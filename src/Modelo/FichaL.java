...
public class FichaL extends Ficha {
    ...
    public FichaL() {
        for (int i = 0; i < 4; i++) {
            this.cadrados.add(new Cadrado(java.awt.Color.green));
        }
        posicionInicial();
        posicion = 0;
    }
    ...
    private boolean rotar0() {
        ...
        this.cadrados.get(3).darPosicion(this.cadrados.get(3).getX(), this.cadrados.get(3).getY() - 2 * Xogo.LADO_CADRADO);
    ...
    private boolean rotar1() {
        ...
        this.cadrados.get(3).darPosicion(this.cadrados.get(3).getX() - 2 * Xogo.LADO_CADRADO, this.cadrados.get(3).getY());
